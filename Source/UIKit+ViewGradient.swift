...
extension UIView {
  @discardableResult
  public func gradient(startColor: UIColor, endColor: UIColor, startPoint: GradientStartPoint) -> Self {
    let gradientLayer = makeGradientLayer().then {
...
fileprivate extension CAGradientLayer {
  fileprivate func startPoint(_ startPoint: GradientStartPoint) {
    switch startPoint {
    case .top:
    ...
    case let .custom(start, end):
      ...
      endPoint = CGPoint(x: end.x, y: end.y)
    case .none:
      break
    }
  }
